...
from src.token_speech_text_paired_dataset import load_text_instruction_dataset, SpeechTextPairedDataCollator
from src.owntoken import SPECIA_TOKENS, WLT, AUDIO_UNIT_TOKENS
from src.modeling_blsp import PartiallyTrainedLMHead, PartiallyTrainedEmbedding
...
def main():
    ...
    # 4. Load tokenizer
    print(model_args.llama_model)
    tokenizer = LlamaTokenizer.from_pretrained("checkpoints/conversion_speech_hubert_new")
    # new_embedding_nums = tokenizer.add_special_tokens({"additional_special_tokens": AUDIO_UNIT_TOKENS})
    ### 5. Load dataset
    ...
    # model = LlamaForCausalLM.from_pretrained("checkpoints/speeech_hubert_new_chinese_only_asr/checkpoint-5600", _fast_init=not is_deepspeed_zero3_enabled())
